...
bool ImwPlatformWindowEasyWindow::Init(ImwPlatformWindow* pMain)
{
	...
	EasyWindow::EWindowStyle eStyle = EasyWindow::E_STYLE_POPUP;
	...
	m_pWindow = EasyWindow::Create("ImwPlatformWindowEasyWindow", 800, 600, false, pMain != NULL ? pMainWindow->m_pWindow : NULL, eStyle, EasyWindow::E_FLAG_CATCH_ALT_KEY | EasyWindow::E_FLAG_ALWAYS_CAPTURE_MOUSE_ON_CLICK);
